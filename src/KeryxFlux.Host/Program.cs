...
using KeryxFlux.Infrastructure.MessageBrokers.Tcp;
...
builder.Services.AddSingleton<ITcpReceiverService, TcpReceiver>();
...
builder.Services.AddSingleton<ISender, TcpSender>();
